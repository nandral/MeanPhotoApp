var helpers = require('./helpers.js'),
  album_data = require("../data/album_ds.js"),
  async = require('async'),
  fs = require('fs');
...
exports.add_photo_to_album = function (req, res) {
  console.log("=========================---------------------------");
  console.log(JSON.stringify(req.files.files));
  console.log("=========================---------------------------");
  ...
  async.waterfall([
      ...
      function (cb) {
        ...
        else if (!helpers.is_image(photos[0].originalFilename))
      ...
      function (album_data, cb) {
        ...
        // album.add_photo(req.body, photos[0].path, cb);


        async.each(photos, function (file, callback) {
          req.body.filename = file.originalname;
          // Perform operation on file here.
          console.log('Processing file ' + file.name);
          album.add_photo({
            "albumid": req.params.album_name,
